...
class DealershipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dealership" do
    assert_difference("Dealership.count") do
      post dealerships_url, params: { dealership: { description: @dealership.description, location: @dealership.location, name: @dealership.name } }
    end
  ...
  test "should update dealership" do
    patch dealership_url(@dealership), params: { dealership: { description: @dealership.description, location: @dealership.location, name: @dealership.name } }
